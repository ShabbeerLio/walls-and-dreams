        ...
        <div className='ContactUs'>
            ...
            <div className='ContactUs-main'>
                <div className='ContactUs-box'>
                    <div className='ContactUs-box-heading'>
                        <h2>Take a coffee & chat with me</h2>
                        <div className="contactUs-heading-contact">
                            <div className="contactUs-contact-card">
                                <Link>
                                    <p><FaEnvelope/></p>
                    ...
                    <div className="ContactUs-box-body">
                        <Form btntxt={"Send message"} />
                    </div>
                </div>
            </div>
        </div>
